    ...
    return (
      <div className="App">
        ...
        <div className = "middlePointDiv">
          <h1>FOREX</h1>
          <h3 className = "whiteText">Spread Betting and CFD on 10,000+ global markets.</h3>
          <p>Low margins, tight spreads and fast execution on award-winning platform with powerful technology.</p>
          <div className = "optionsDiv">
            <button className = "tradeNowButton">TRADE NOW</button>
            <h6 className = "underlineOption">or create a risk-free Demo account</h6>
          </div>
        </div>
        <div className="bottomDiv">
          ...
          <div className = "column2">
            ...
            <ul>
              ...
              <li>Spread bet or trade CFDs on over 300 major, minor and exotic FX pairs</li>
